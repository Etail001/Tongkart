...
/* techeco/template/common/currency.twig */
class __TwigTemplate_04c762f4700d9278c3b1a6ca1177715d67e329ac141bd017f990cfbf2363b811 extends Twig_Template
{
...
";
    ...
    {
        return "techeco/template/common/currency.twig";
    }
...
/*     <div class="btn-group">*/
/*       <button class="btn btn-link dropdown-toggle test" data-toggle="dropdown">{% for currency in currencies %}*/
...
/*       {% endfor %} <span>{{ text_currency }}</span>&nbsp;<i class="fa fa-angle-down"></i></button>*/
/*       <ul class="dropdown-menu">*/
/*         {% for currency in currencies %}*/
/*         {% if currency.symbol_left %}*/
/*         <li>*/
/*           <button class="currency-select btn btn-link" type="button" name="{{ currency.code }}">{{ currency.symbol_left }} {{ currency.title }}</button>*/
/*         </li>*/
/*         {% else %}*/
/*         <li>*/
/*           <button class="currency-select btn btn-link" type="button" name="{{ currency.code }}">{{ currency.symbol_right }} {{ currency.title }}</button>*/
/*         </li>*/
/*         {% endif %}*/
/*         {% endfor %}*/
/*       </ul>*/
