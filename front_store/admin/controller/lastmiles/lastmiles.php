<?php
class ControllerLastmilesLastmiles extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$order_total = $this->model_lastmiles_lastmiles->getTotalOrders($filter_data);

		$results = $this->model_lastmiles_lastmiles->getOrders($filter_data);
		...
		$this->response->setOutput($this->load->view('lastmiles/order_list', $data));
	}
				...
				$paramsorder = array
							...
							'addOrderRequestInfoArray' => array
								(
									...
									'customerOrderNo' => $order_info['temp_id'],//$dataFilter[$j]['data'],
									'Tins' => '06AAECE3376N1ZA',
									'shipperAddresstype' => '2',
									'shipperName' => 'ETAIL CONSULTANTS',
									'shipperEmail' => 'operations@inetail.com',
									'shipperAddress' => 'Emaar Digital Greens, Tower B, Unit 914, Gurgaon, Haryana,Sector 61, 122102',
									'shipperPhone' => '8826234908',
									'shipperPostcode' => '110037',
									'shipperCompanyName' => 'ETAIL CONSULTANTS',
									'shippingMethod' => 'blue-dart',
									'shipperCountryCode' => 'IN',
									'shipperCountryName' => 'INDIA',
									'recipientCountry' => 'India',
									'recipientCountryCode' => 'IN',
									'shipperCity' => 'Delhi',
									'shipperStateOrProvinceCode' => 'DL',
									'recipientName' => $order_info['shipping_firstname'],
									'recipientState' => '',
									'recipientStateOrProvinceCode' => 'DL',
									'recipientCity' => $order_info['shipping_city'],
									'recipientAddress' =>$order_info['shipping_address_1'],
									'recipientZipCode' => '110037',
									'recipientPhone' => trim('9205103665'),
									'recipientEmail' => $order_info['email'],
									'goodsDescription' => $product['name'],
									'goodsQuantity' => $product['quantity'],
									'goodsDeclareWorth' => '1',
									'goodsWeight' => '1',
									'goodsLength' => '1', 
									'goodsWidth' => '1',
						...
						$url = "http://54.211.226.195/wms/Awbgenerates/addOrderRquest";
						...
						$url='';
						$this->response->redirect($this->url->link('lastmiles/lastmiles', 'user_token=' . $this->session->data['user_token'] . $url, true));
