<?php
class ControllerFirstmilesScanDocument extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$order_total = $this->model_firstmiles_firstmiles->getTotalScans($filter_data);

		$results = $this->model_firstmiles_firstmiles->getScans($filter_data);
		
		foreach ($results as $result) {
			
			$data['orders'][] = array(
				'order_id'      => $result['order_id'],
				'traking_number' =>$result['awb'],
				'msg' => $result['msg'],
			...
			<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
			  <soap:Body>
				<PickUpEntry xmlns="http://grandslamexpress.in/">
				  ...
				  <PickupDate>15-Aug-2018</PickupDate>
