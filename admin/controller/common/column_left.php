...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$tongkart = array();
			if ($this->user->hasPermission('access', 'tongkart/order')) {
				$tongkart[] = array(
					'name'	   => 'Orders',
					'href'     => $this->url->link('tongkart/order', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        $tongkart_catalog = array();
			
                        if ($this->user->hasPermission('access', 'tongkart/all_products')) {
				$tongkart_catalog[] = array(
					'name'	   => 'All Products',
					'href'     => $this->url->link('tongkart/all_products', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'tongkart/catalog_new')) {
				$tongkart_catalog[] = array(
					'name'	   => 'New Products',
					'href'     => $this->url->link('tongkart/catalog_new', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			
			if ($this->user->hasPermission('access', 'tongkart/restricted')) {	
				$tongkart_catalog[] = array(
					'name'	   => 'Restricted',
					'href'     => $this->url->link('tongkart/restricted', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			
			if ($this->user->hasPermission('access', 'tongkart/listed')) {		
				$tongkart_catalog[] = array(
					'name'	   => 'Listed',
					'href'     => $this->url->link('tongkart/listed', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($tongkart_catalog) {
				$tongkart[] = array(
					'name'	   => 'Catalog',
					'href'     => '',
					'children' => $tongkart_catalog		
				);
			}
                        if ($this->user->hasPermission('access', 'tongkart/customer')) {
				$tongkart[] = array(
					'name'	   => "Seller's Detail",
					'href'     => $this->url->link('tongkart/customer', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        $tongkart_enquiry = array();
                        if ($this->user->hasPermission('access', 'tongkart/enquiry')) {
				$tongkart_enquiry[] = array(
					'name'	   => 'Order Enquiry',
					'href'     => $this->url->link('tongkart/enquiry', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($this->user->hasPermission('access', 'tongkart/product_enquiry')) {
				$tongkart_enquiry[] = array(
					'name'	   => 'Product Enquiry',
					'href'     => $this->url->link('tongkart/product_enquiry', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($tongkart_enquiry) {
				$tongkart[] = array(
					'name'	   => 'Enquiry',
					'href'     => '',
					'children' => $tongkart_enquiry		
				);
			}
                        $tongkart_price = array();
                        if ($this->user->hasPermission('access', 'tongkart/price')) {
				$tongkart_price[] = array(
					'name'	   => 'Admin Price',
					'href'     => $this->url->link('tongkart/price', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($this->user->hasPermission('access', 'tongkart/product_price')) {
				$tongkart_price[] = array(
					'name'	   => 'Product Wise Price',
					'href'     => $this->url->link('tongkart/product_price', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($this->user->hasPermission('access', 'tongkart/price_history')) {
				$tongkart_price[] = array(
					'name'	   => 'Product Price Details',
					'href'     => $this->url->link('tongkart/price_history', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($tongkart_price) {
				$tongkart[] = array(
					'name'	   => 'Price',
					'href'     => '',
					'children' => $tongkart_price		
				);
			}
                        if ($this->user->hasPermission('access', 'tongkart/settings')) {
				$tongkart[] = array(
					'name'	   => 'Settings',
					'href'     => $this->url->link('tongkart/settings', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
                        if ($tongkart) {
			...
			if ($this->user->hasPermission('access', 'catalog/price')) {
				$catalog[] = array(
					'name'	   => 'Price Filter',
					'href'     => $this->url->link('catalog/price', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'firstmiles/firstmiles')) {
				$firstmiles[] = array(
					'name'	   => $this->language->get('text_orders'),
					'href'     => $this->url->link('firstmiles/firstmiles', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'firstmiles/firstmiles')) {
				$firstmiles[] = array(
					'name'	   => $this->language->get('text_packet_status'),
					'href'     => $this->url->link('firstmiles/packetStatus', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'firstmiles/firstmiles')) {
				$firstmiles[] = array(
					'name'	   => $this->language->get('text_scan_document_status'),
					'href'     => $this->url->link('firstmiles/scanDocument', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($firstmiles) {
				$data['menus'][] = array(
					'id'       => 'menu-marketing',
					'icon'	   => 'fa-share-alt', 
					'name'	   => $this->language->get('text_wms'),
					'href'     => '',
					'children' => $firstmiles
				);	
			}*/
			...
			if ($this->user->hasPermission('access', 'paytm/paytm')) {
				$paytm[] = array(
					'name'	   => $this->language->get('text_paytm'),
					'href'     => $this->url->link('paytm/paytm', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'quark/quark')) {
				$quark[] = array(
					'name'	   => $this->language->get('text_quark'),
					'href'     => $this->url->link('quark/quark', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'seller/seller')) {
				$sellerwms[] = array(
					...
					'href'     => $this->url->link('seller/seller', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			/*if ($this->user->hasPermission('access', 'firstmiles/firstmiles')) {
			...
			if ($sellerwms) {
				$data['menus'][] = array(
					'id'       => 'menu-marketing',
					'icon'	   => 'fa-share-alt', 
					'name'	   => $this->language->get('text_seller_wms'),
					'href'     => '',
					'children' => $sellerwms
				);	
			}
			...
			if ($this->user->hasPermission('access', 'cnwms/cnwms')) {
				$cnwms[] = array(
					'name'	   => $this->language->get('text_cnwms_orders'),
					'href'     => $this->url->link('cnwms/cnwms', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'cnwms/cnwms')) {
				$cnwms[] = array(
					'name'	   => $this->language->get('text_qc'),
					'href'     => $this->url->link('cnwms/cnwms/qclist', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($cnwms) {
				$data['menus'][] = array(
					'id'       => 'menu-marketing',
					'icon'	   => 'fa-share-alt', 
					'name'	   => $this->language->get('text_cnwms'),
					'href'     => '',
					'children' => $cnwms
				);	
			}
			...
			if ($this->user->hasPermission('access', 'cnwms/shipments')) {
				$shipments[] = array(
					'name'	   => $this->language->get('text_create_shipments'),
					'href'     => $this->url->link('cnwms/shipments', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'cnwms/shipments')) {
				$shipments[] = array(
					'name'	   => $this->language->get('text_shipment_list'),
					'href'     => $this->url->link('cnwms/shipments/shipmentList', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'cnwms/shipments')) {
				$shipments[] = array(
					'name'	   => $this->language->get('text_shipment_scan'),
					'href'     => $this->url->link('cnwms/shipments/uploadScanDocument', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'cnwms/shipments')) {
				$shipments[] = array(
					'name'	   => $this->language->get('text_docs_scan'),
					'href'     => $this->url->link('cnwms/shipments/docsList', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'cnwms/shipments')) {
				$shipments[] = array(
					'name'	   => $this->language->get('text_track_status'),
					'href'     => $this->url->link('cnwms/shipments/trackShipments', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'lastmiles/lastmiles')) {
				$lastmiles[] = array(
					'name'	   => $this->language->get('text_orders'),
					'href'     => $this->url->link('lastmiles/lastmiles', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'lastmiles/lastmiles')) {
				$lastmiles[] = array(
					'name'	   => $this->language->get('text_awb_view'),
					'href'     => $this->url->link('lastmiles/shipped', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'wms/wms')) {
				$lastmiles[] = array(
					'name'	   => $this->language->get('text_track'),
					'href'     => $this->url->link('wms/wms', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($lastmiles) {
				$data['menus'][] = array(
					'id'       => 'menu-marketing',
					'icon'	   => 'fa-share-alt', 
					'name'	   => $this->language->get('text_lastmiles'),
					'href'     => '',
					'children' => $lastmiles
				);	
			}
