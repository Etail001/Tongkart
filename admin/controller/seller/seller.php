...
class ControllerSellerSeller extends Controller {
	...
	protected function getList() {
		...
		$data['action_s'] = $this->url->link('seller/seller/marksasshipped', 'user_token=' . $this->session->data['user_token'] . $url, true);
	...
	public function download()
	{
		...
		$writer->addRow(['Order Id','Product Sku','Model','Order Date','Product Name','QTY','Price','Shipping Cost','Total']);
		$writer->addRows($rows);
	...
	public function marksasshipped()
	{
		...
		$this->model_seller_order->markShippeds($orders);
		$url='';
