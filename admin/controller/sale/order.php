...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		$data['sort_status'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=order_status' . $url, true);
                $data['sort_original_order'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.sort_original_order' . $url, true);
                $data['sort_store_name'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.store_name' . $url, true);
                $data['sort_payment_country'] = $this->url->link('sale/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.payment_country' . $url, true);
