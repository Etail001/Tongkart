<?php
class ModelTongkartCustomer extends Model {
	...
	public function getCustomers($data = array()) {
		$sql = "SELECT c.*, CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.name AS customer_group,cs.status FROM " . DB_PREFIX . "customer c LEFT JOIN " . DB_PREFIX . "customer_group_description cgd ON (c.customer_group_id = cgd.customer_group_id) LEFT JOIN " . DB_PREFIX . "amazon_customer_settings cs ON (c.customer_id = cs.customer_id)";
