<?php
class ModelTongkartRestricted extends Model {
	...
	public function getProducts($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "' and p.amazon_status = 'restricted'";
	...
	public function getTotalProducts($data = array()) {
		...
		$sql .= " WHERE pd.language_id = '" . (int)$this->config->get('config_language_id') . "' and p.amazon_status = 'restricted'";
	...
	public function getListingPrice($product_id,$price) {
        ...
        public function UpdateStatus($status) {
                $this->db->query("UPDATE `" . DB_PREFIX . "product` SET  amazon_status = '' where product_id =".$status);
	}
}
