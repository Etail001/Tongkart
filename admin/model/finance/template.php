<?php
class ModelCrmTemplate extends Model {
	...
	public function GetTemplateCategoryList($data = array()) {
		$sql = "select a.cat_name,b.* from oc_et_template_categories as a left join oc_et_template_subcategory as b on a.id=b.template_category_id";
	...
	{
		$query = $this->db->query("select id,sub_subcategory_name from oc_et_template_subcategory");
		return $query->rows;
	}
	...
	public function insertTemplate($data = array())
	{
		...
		$msg = serialize($data['message']);
		
		//echo "insert into oc_et_template_desc set sub_subcategory_id='" . $this->db->escape($data['category']) . "',sub_template_desc='" . $this->db->escape($data['descriptions']) . "',template_desc='" . $this->db->escape($data['message']) . "'";die;
		$query = $this->db->query("insert into oc_et_template_desc set sub_subcategory_id='" . $this->db->escape($data['category']) . "',sub_template_desc='" . $this->db->escape($data['descriptions']) . "',
		template_desc='" . $this->db->escape($data['message']) . "'");
		//return $query->rows;
	}
